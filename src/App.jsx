...
const data = {
  ...
  titles: ['Software Engineer', 'UI/UX Designer', 'AI Enthusiast', 'Creative Coder'],
  ...
  stats: [
    ...
    { value: 99, suffix: '%', label: '🐛 Bugs Fixed*', footnote: '*created new ones' },
        ...
        {links.map((l, i) => (
          <li key={l} style={{ animationDelay: `${i * 0.05}s` }}>
            <a href={`#${l}`} onClick={() => setOpen(false)}>
              <span className="nav__link-num">0{i + 1}.</span>{l}
            </a>
          </li>
        ))}
        <li><a href={`mailto:${data.email}`} className="nav__cta">Hire Me</a></li>
      </ul>
    </nav>
  )
}
    ...
    <section id="hero" className="hero">
      ...
      <div className="hero__inner">
        <div className="hero__left">
          <Reveal>
            <p className="hero__eyebrow"><span className="accent-dot" />Hello World, I'm</p>
        ...
        <div className="hero__right">
          <Reveal delay={0.2}>
            <div className="avatar-wrap">
              ...
              <img src="/avatar.jpg" alt="Xaviero Kenjiro Farrell" className="avatar-img" />
      ...
      <div className="hero__scroll-hint">
        <div className="mouse"><div className="mouse-dot" /></div>
        <span>scroll</span>
      </div>
    </section>
  )
    ...
    <div className="stats-bar">
      {data.stats.map((s, i) => (
        <Reveal key={i} delay={i * 0.1} className="stat-item">
          <p className="stat-value"><Counter value={s.value} suffix={s.suffix} /></p>
  ...
  return (
    <section id="about" className="section">
      <div className="section__inner">
        <Reveal>
          <p className="section__label"><span className="accent">//</span> About Me</p>
        ...
        <div className="about__grid">
            ...
            <div className="about__text">
              ...
              <div className="edu-card">
                ...
                <div>
                  ...
                  <p className="edu-card__meta">{data.education.location} · {data.education.period}</p>
                  <p className="edu-card__gpa">GPA: <span className="accent">{data.education.gpa}</span></p>
                </div>
              </div>
            </div>
          </Reveal>
          <Reveal delay={0.2}>
            <div className="leadership-card">
              <div className="lcard__label"><span className="accent">//</span> Leadership</div>
              ...
              <ul className="lcard__points">
                {data.leadership.points.map((p, i) => (
                  <li key={i}><span className="accent">▹</span> {p}</li>
                ))}
              </ul>
            </div>
          </Reveal>
...
function Experience() {
  return (
    <section id="experience" className="section section--alt">
      <div className="section__inner">
        <Reveal>
          <p className="section__label"><span className="accent">//</span> Experience</p>
              ...
              <div className="timeline__item">
                ...
                <div className="timeline__card">
                  ...
                  <ul className="tcard__points">
                    {e.points.map((pt, j) => (
                      <li key={j}><span className="accent">▹</span> {pt}</li>
                    ))}
                  </ul>
                </div>
              </div>
...
function Projects() {
  return (
    <section id="projects" className="section">
      <div className="section__inner">
        <Reveal>
          <p className="section__label"><span className="accent">//</span> Projects</p>
...
function Skills() {
  return (
    <section id="skills" className="section section--alt">
      <div className="section__inner">
        <Reveal>
          <p className="section__label"><span className="accent">//</span> Skills</p>
        ...
        <div className="skills__layout">
          ...
          <div className="skills__tools">
            <Reveal delay={0.1}>
              <p className="skills__tools-label"><span className="accent">//</span> Tools & Extras</p>
  ...
  return (
    <div className="skill-bar" ref={ref}>
      <div className="skill-bar__header">
        <span>{name}</span><span className="skill-bar__pct">{level}%</span>
      </div>
  ...
  return (
    <section id="contact" className="section contact-section">
      <div className="section__inner section__inner--center">
        <Reveal>
          <p className="section__label"><span className="accent">//</span> Contact</p>
          ...
          <a href={`mailto:${data.email}`} className="btn btn--glow contact__btn">
            Say Hello ✉
          </a>
  ...
  return (
    <footer className="footer">
      <p>
        ...
        Designed &amp; built by Xaviero Kenjiro Farrell · {new Date().getFullYear()}
        <span className="accent"> /&gt;</span>
      </p>
    </footer>
  )
...
function FolderIcon() {
  return (
    <svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" style={{ color: 'var(--accent-color, #00d4aa)', opacity: 0.7 }}>
